...
set mouse=a
set ruler
set runtimepath=~/.vim,~/.vim/pack/vendor/start/nerdtree,/usr/share/vim/site,/usr/share/vim/vim80,/usr/share/vim/site/after,~/.vim/after
set showmatch
let s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
let v:this_session=expand("<sfile>:p")
silent only
cd ~/Projects/hpc_RobeyZamora/git_Robey_Zamora_2021_EssentialsOfParallelComputing
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 README.md
badd +0 Chapter2/Listing1/CMakeLists.txt
badd +28 Chapter2/README.autovirtualbox
badd +0 Chapter2/Setup.Ubuntu20.04
argglobal
silent! argdel *
$argadd README.md
set stal=2
...
exe 'vert 2resize ' . ((&columns * 161 + 96) / 193)
argglobal
enew
file NERD_tree_1
let s:cpo_save=&cpo
...
exe 'vert 1resize ' . ((&columns * 31 + 96) / 193)
exe 'vert 2resize ' . ((&columns * 161 + 96) / 193)
tabedit Chapter2/Setup.Ubuntu20.04
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
5
normal! 011|
tabedit Chapter2/Listing1/CMakeLists.txt
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
